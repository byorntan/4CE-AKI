...
no_aki_list <- no_aki_list[,c(1,3,2,4)]

aki_index <- bind_rows(aki_index,no_aki_list)
...
peak_aki_trend <- peak_aki_trend[,c(1,7,2,6,3,4,5)]
...
peak_aki_trend <- peak_aki_trend[,c(1,2,8,10)]
